...
class Item implements Comparable<Item>{ 
	// Define the Item class to implement the Comparable interface.
	// An Item must be compared to another Item, ONLY.
  ...
  /**
   * Compares an Item with another Item based on price value
   * 
   * @param other
   */
  @Override
  ...
  // Override/Implement the Comparable.compareTo method.
...
// Checkpoint: SAVE YOUR SOURCE FILE (Ctrl/Cmd + S)
...
public class Shelf<T extends Comparable<T>> {
  ...
  public static boolean testAddFirst() {
    try {
      ...
      // TODO Define an array named expected of type Item[] having the same capacity as the shelf and
      // which contains the expected contents of the array data of the shelf after adding the 4 items.
